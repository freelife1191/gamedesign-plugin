...
- 각 승인 transition은 named reviewer와 artifact 내부 evidence를 기록한다. review record의 human kind와 stage-bound role/scope는 lifecycle이 폐쇄적으로 파생한다. 실제 사용자 승인 입력의 신뢰 경계는 `review-image-assets` 운영 절차가 소유한다.

...
게임 기획 문서에서 번역투, 불필요한 관용 표현, 기계적인 나열, 문맥이 끊기는 문장을 찾고 최소 수정안을 기록한다. 사실·수치·근거·결정 상태는 다루지 않는다.
...
- 게임 기획자가 바로 이해하기 어려운 번역투·과장·반복이 있는가?
- 앞뒤 문단의 주어, 대상, 시점이 자연스럽게 이어지는가?
- 약어·코드명이 처음 나올 때 필요한 설명이 있는가?
- 의미를 바꾸지 않는 가장 작은 문장 수정은 무엇인가?

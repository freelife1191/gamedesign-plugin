...
version: 1
---
# 결정 및 변경 이력 {#decision-change-log}

## 결정 기록 기준 {#decision-contract}

모든 decision-id에는 날짜, 담당자, 상태, 맥락, 대안, 근거 ID, 근거, 영향, 승인자, 승인일, 재개 조건을 기록한다.

## 변경 추적성 {#change-traceability}

중요한 변경마다 영향받는 안정 섹션 ID, 이전 결정, 새 근거, 호환성 또는 마이그레이션 영향, 롤백 경로, 다음 검토일을 연결한다.
...
| `date` | not-observed | 승인 전에 프로젝트별 값과 근거 위치를 기록한다. | artifact-owner |
...
| `context` | not-observed | 승인 전에 프로젝트별 값과 근거 위치를 기록한다. | artifact-owner |
| `alternatives` | not-observed | 승인 전에 프로젝트별 값과 근거 위치를 기록한다. | artifact-owner |
| `evidence-ids` | not-observed | 승인 전에 프로젝트별 값과 근거 위치를 기록한다. | artifact-owner |
| `rationale` | not-observed | 승인 전에 프로젝트별 값과 근거 위치를 기록한다. | artifact-owner |
| `approver` | not-observed | 승인 전에 프로젝트별 값과 근거 위치를 기록한다. | artifact-owner |
| `reopen-condition` | not-observed | 승인 전에 프로젝트별 값과 근거 위치를 기록한다. | artifact-owner |

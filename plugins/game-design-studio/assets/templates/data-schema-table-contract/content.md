...
version: 1
---
# 기획 항목: Data Schema and Table Contract {#data-schema-table-contract}

## 기획 항목: Schema Contract {#schema-contract}
...
## 기획 항목: Design to Runtime Boundary {#design-to-runtime-boundary}

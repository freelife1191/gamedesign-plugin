...
version: 1
---
# 기획 항목: Portfolio Project Brief {#portfolio-project-brief}

## 기획 항목: Decision Chain {#decision-chain}

Use the exact sequence target-competency → problem-user → evidence → hypothesis-intent → rules/UI/data/content → constraints-alternatives → implementation-test → result-decision → retrospective.

## 기획 항목: Publication Boundary {#publication-boundary}

Record personal/team attribution, third-party source, use purpose, rights, privacy, implementation status, and evidence limitations.
...
| `problem-user` | not-observed | Record a project-specific value and evidence address before approval. | artifact-owner |
| `evidence` | not-observed | Record a project-specific value and evidence address before approval. | artifact-owner |
| `hypothesis-intent` | not-observed | Record a project-specific value and evidence address before approval. | artifact-owner |
| `rules-ui-data-content` | not-observed | Record a project-specific value and evidence address before approval. | artifact-owner |
| `constraints-alternatives` | not-observed | Record a project-specific value and evidence address before approval. | artifact-owner |
| `implementation-test` | not-observed | Record a project-specific value and evidence address before approval. | artifact-owner |
| `result-decision` | not-observed | Record a project-specific value and evidence address before approval. | artifact-owner |
| `retrospective` | not-observed | Record a project-specific value and evidence address before approval. | artifact-owner |

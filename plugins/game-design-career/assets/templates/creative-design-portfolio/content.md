...
version: 1
---
# 기획 항목: Creative Design Portfolio {#creative-design-portfolio}

## 기획 항목: Portfolio Story {#portfolio-story}

For every material claim-id, connect target competency, problem, decision rationale, alternative, implementation boundary, result, and reflection to an evidence-id.

## 기획 항목: Third-party and Publication Rights {#third-party-and-publication-rights}
...
| `third-party-source` | not-observed | Record a project-specific value and evidence address before approval. | artifact-owner |
...
| `use-purpose` | not-observed | Record a project-specific value and evidence address before approval. | artifact-owner |

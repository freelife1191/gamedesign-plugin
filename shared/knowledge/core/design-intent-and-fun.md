...
```claim
{
  ...
  "type": "evergreen",
  "basis": "synthesis",
  "guidance": "기능을 나열하기 전에 대상 플레이어, 반복해서 느끼게 할 감정, 그 감정을 만드는 선택과 피드백을 한 문장으로 정의한다.",
...
```
의도 문장은 슬로건이 아니라 선택 기준이다. 후보 기능이 목표 경험에 어떤 플레이어 행동을 통해 기여하는지 설명하지 못하면 축소하거나 실험 대상으로 돌린다.

...
const KOREAN_UI = Object.freeze([
  ...
  ["LENS", "렌즈"], ["MAP", "지도"], ["PATH", "경로"], ["READ 100%", "읽기 100%"], ["FULL", "전체"], ["AUTO", "자동"], ["S cycles", "S 키로 전환"], ["Drag to pan", "끌어서 이동"], ["Click node", "노드 클릭"], ["6s motion", "6초 움직임"], ["vector", "벡터"], ["data store", "데이터 저장소"], ["async batch", "비동기 묶음"], ["primary data", "주 데이터"], ["policy / PII", "정책 / 개인정보"],
]);

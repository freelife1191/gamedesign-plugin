...
export function renderPromptGuideSummary(entries) {
  ...
  return [
    "### 재사용 프롬프트 템플릿",
    "",
    ...ordered.map((entry) => `- [${entry.level}${entry.skill === "design-cutscene-visual-preproduction" ? ":" : " —"} ${entry.title}](../../prompt-templates/${entry.product}/${entry.skill}.md#${entryAnchor(entry)})`),
  ].join("\n");
}

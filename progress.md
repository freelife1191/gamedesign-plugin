...
- Fix7: canonical+ownerAnchor+retired nlink=3 crash 재개, 정확 inode ownerAnchor 선택(다른 세대 orphan 무시), live claim lease gate, canonical release EIO 보존을 추가했다. `node --test tests/unit/game-design-update-check.test.mjs`는 46/46을 통과했다.

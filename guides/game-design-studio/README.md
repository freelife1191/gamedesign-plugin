...
3. [템플릿 15개](templates.md)에서 목적에 맞는 템플릿을 고르고, 필요하면 [스킬 21개](skills/README.md)의 연결된 스킬을 직접 호출합니다.
...
각 스킬 ID는 [스킬 21개](skills/README.md)에서 해당 상세 가이드로 직접 연결됩니다. 각 템플릿의 용도와 복사 가능한 요청문은 [템플릿 15개](templates.md)에 있습니다.

...
Career 사례는 직무·경험·공고·포트폴리오를 증거와 사람 검토에 연결하는 방법을 안내합니다. 아래 요청은 초안을 만들 뿐이며, 합격·채용·승진·회사 평가는 보장하지 않습니다.
...
**예상 결과·읽는 순서:** `content.md`의 role path, `evidence.yml`의 evidence ID, `competency-matrix/content.md`의 gap과 proof task가 남습니다. `content.md → evidence.yml → competency-matrix/content.md` 순서로 읽습니다.
...
**예상 결과·읽는 순서:** `content.md`의 claim-id, `evidence.yml`의 출처·권리, `portfolio-project-brief/content.md`의 가장 작은 proof artifact가 남습니다. `content.md → evidence.yml → portfolio-project-brief/content.md` 순서로 읽습니다.
...
**언제·왜:** 학교 정책과 팀 동의를 확인한 뒤, 맡은 문제·변경 전후·검토 feedback을 claim-evidence index에 남길 때 사용합니다. 이는 2026-08-06 확인 기준의 [EA Early Careers FAQ](https://www.ea.com/careers/early-careers/faq)에서 학교 프로젝트와 포트폴리오를 관심·역량의 증거로 볼 수 있다고 한 원칙을 제한적으로 적용한 것입니다.
...
**예상 결과·읽는 순서:** `content.md`의 claim-id·attribution, `evidence.yml`의 source와 권리, `creative-design-portfolio/content.md`의 case study가 남습니다. `content.md → evidence.yml → creative-design-portfolio/content.md` 순서로 읽습니다.
...
**예상 결과·읽는 순서:** `content.md`의 posting record, `evidence.yml`의 sourceUrl·reviewAfter, `job-posting-evidence/content.md`의 repeated signal이 남습니다. `content.md → evidence.yml → job-posting-evidence/content.md` 순서로 읽습니다.
...
**예상 결과·읽는 순서:** `content.md`의 sample boundary, `evidence.yml`의 retrievalDate·region, `job-posting-evidence/content.md`의 non-generalizable constraint가 남습니다. `content.md → evidence.yml → job-posting-evidence/content.md` 순서로 확인합니다.
...
**예상 결과·읽는 순서:** `content.md`의 observation·inference, `evidence.yml`의 locator, `reverse-design-document/content.md`의 validation queue가 남습니다. `content.md → evidence.yml → reverse-design-document/content.md` 순서로 읽습니다.
...
**예상 결과·읽는 순서:** `content.md`의 observation scope, `evidence.yml`의 source location, `reverse-design-document/content.md`의 unknown·validation queue가 남습니다. `content.md → evidence.yml → reverse-design-document/content.md` 순서로 읽습니다.
...
**언제·왜:** 역할별 공고와 현재 proof를 비교해 중복 case를 줄이고, 각 문서가 다른 문제를 보여 주는지 검토할 때 사용합니다. 2026-08-06 확인 기준의 [Ubisoft Hiring Process](https://www.ubisoft.com/en-us/company/careers/locations/articles/our-hiring-process)는 관련 프로젝트·context와 quality over quantity를 강조하지만 회사 양식을 복제하지 않습니다.
...
**예상 결과·읽는 순서:** `content.md`의 case index, `evidence.yml`의 claim locator, `creative-design-portfolio/content.md`의 selection rationale이 남습니다. `content.md → evidence.yml → creative-design-portfolio/content.md` 순서로 읽습니다.
...
**예상 결과·읽는 순서:** `content.md`의 claim 기록, `evidence.yml`의 locator, `five-axis-review/content.md`의 finding·minimum-repair가 남습니다. `content.md → evidence.yml → five-axis-review/content.md` 순서로 읽습니다.
...
**예상 결과·읽는 순서:** `content.md`의 attribution·claim-id, `evidence.yml`의 team source, `creative-design-portfolio/content.md`의 개인 기여 경계가 남습니다. `content.md → evidence.yml → creative-design-portfolio/content.md` 순서로 읽습니다.
...
**예상 결과·읽는 순서:** `content.md`의 공개 제외 경계, `evidence.yml`의 권리·privacy disposition, `portfolio-project-brief/content.md`의 새 proof task가 남습니다. `content.md → evidence.yml → portfolio-project-brief/content.md` 순서로 읽습니다.
...
**예상 결과·읽는 순서:** `content.md`의 asset 기록, `evidence.yml`의 decision evidence, `assets/image-assets.yml`의 rights·alt text가 남습니다. `content.md → evidence.yml → assets/image-assets.yml` 순서로 읽습니다.
...
**예상 결과·읽는 순서:** `content.md`의 claim, `evidence.yml`의 locator, `five-axis-review/content.md`와 backlog의 finding-id·minimum-repair가 남습니다. `content.md → evidence.yml → five-axis-review/content.md` 순서로 읽습니다.
...
**예상 결과·읽는 순서:** `content.md`의 requirement 비교, `evidence.yml`의 source·reviewAfter, `job-posting-evidence/content.md`의 selection rationale이 남습니다. `content.md → evidence.yml → job-posting-evidence/content.md` 순서로 읽습니다.
...
**예상 결과·읽는 순서:** `content.md`의 questionId, `evidence.yml`의 claim locator, `interview-question-answer-log/content.md`의 answer-feedback이 남습니다. `content.md → evidence.yml → interview-question-answer-log/content.md` 순서로 읽습니다.
...
**예상 결과·읽는 순서:** `content.md`의 questionId, `evidence.yml`의 available evidence, `interview-question-answer-log/content.md`의 honest-answer·verification-task가 남습니다. `content.md → evidence.yml → interview-question-answer-log/content.md` 순서로 읽습니다.
...
**예상 결과·읽는 순서:** `content.md`의 goal, `evidence.yml`의 feedback·freshness, `junior-growth-review/content.md`의 project-event-evidence·next-review-date가 남습니다. `content.md → evidence.yml → junior-growth-review/content.md` 순서로 읽습니다.
...
**예상 결과·읽는 순서:** `content.md`의 route와 unknown, `evidence.yml`의 source·reviewAfter, `career-stage-goal/content.md`의 next proof task가 남습니다. `content.md → evidence.yml → career-stage-goal/content.md` 순서로 읽습니다.

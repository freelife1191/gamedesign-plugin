# Game Design Career 활용 사례

이 인덱스는 Career 사례의 선택과 순서만 안내합니다. 사실, 추론, 제안과 공개 가능 여부를 분리하며, 한 경로나 채용 결과를 보장하지 않습니다.
...
- **10분:** 관찰 사실 하나, 질문 하나, 다음 검토자 하나를 남깁니다.
- **표준:** 템플릿 하나와 evidence ID, 대안, 사람 검토를 연결합니다.
- **포트폴리오:** 개인 기여와 공개·권리 검토를 통과한 별도 Career Artifact만 사용합니다.
- **성장·전환:** current evidence의 날짜·표본·재검색 조건을 보존하고 다음 proof task를 제안으로 둡니다.

## 역량 사례

- [CA-C01 기획 직무와 전문 분야 탐색](competency-paths.md#ca-c01-기획-직무와-전문-분야-탐색)
- [CA-C02 게임 분석 언어와 관찰·추론 분리](competency-paths.md#ca-c02-게임-분석-언어와-관찰추론-분리)
- [CA-C03 현재 채용공고 조사](competency-paths.md#ca-c03-현재-채용공고-조사)
- [CA-C04 역량 격차와 학습·증거 계획](competency-paths.md#ca-c04-역량-격차와-학습증거-계획)
- [CA-C05 관찰 기반 역기획](competency-paths.md#ca-c05-관찰-기반-역기획)
- [CA-C06 창작 기획 포트폴리오](competency-paths.md#ca-c06-창작-기획-포트폴리오)

...
2026-08-11에 `shared/templates`, `shared/knowledge/trends`, 프롬프트 카탈로그 원본, Studio와 Career의 사용자 결과 템플릿을 검사했습니다. 제품별 30개 `content.md`의 보이는 표제와 표 레이블, 각 템플릿의 90개 content/evidence/export 계약 파일을 함께 확인했습니다. `plugins/` 생성물, vendor, README, 샘플 결과, 이미지·도식 자료는 검사와 수정에서 제외했습니다.

...
version: 1
---
# 포트폴리오 백로그 {#portfolio-backlog}

## 백로그 기록 {#backlog-records}

각 항목에 claim-id, evidence-id, 목표 역량, 출처 이력, 개인 또는 팀 기여 표기, 권리, 개인정보, 완성도, 상태, 검토 가능성을 연결합니다.

## 최소 보완 작업 {#minimum-repairs}

근거가 부족한 항목은 공개 전에 minimum-repair, 보완 담당자, 실행 작업, 증빙 산출물, 검토 기준을 기록합니다.

## 작업 기록 {#working-record}

| 항목 ID | 현재 상태 | 근거 또는 다음 작업 | 담당자 |
| --- | --- | --- | --- |
| `backlog-id` | not-observed | 승인 전에 프로젝트별 값과 근거 위치를 함께 기록합니다. | artifact-owner |

...
version: 1
---
# 자기소개와 지원 동기 {#introduction-motivation}

## 주장 맵 {#claim-map}

모든 claim-id에 목표 직무의 요구 사항, evidence-id, 개인·팀 기여 범위, 출처의 한계를 연결합니다. 지원 동기와 검증된 경험은 구분합니다.

## 사실성과 개인정보 범위 {#honest-and-private-boundary}

근거가 없을 때는 honest-boundary를 사용합니다. 불필요한 개인정보를 삭제하고, 공유 전 개인정보와 공개 승인을 기록합니다.
...
| `motivation` | not-observed | 승인 전에 프로젝트별 값과 근거 위치를 함께 기록합니다. | artifact-owner |
| `honest-boundary` | not-observed | 승인 전에 프로젝트별 값과 근거 위치를 함께 기록합니다. | artifact-owner |

...
## Roadmap Commitments {#roadmap-commitments}

For every requirement-id, record a learning-task, owner, cadence, proof-artifact, reviewer, and re-evaluation decision.

## Sequence and Dependencies {#sequence-and-dependencies}

Mark durations as provisional until capacity evidence exists. Keep prerequisites, feedback points, and scope choices explicit.

...
version: 1
---
# 비전 및 핵심 원칙 {#vision-pillars}

## 비전 및 핵심 원칙 {#vision-and-pillars}

각 pillar-id에 목표 플레이어 약속, 목표 감정, 핵심 재미, 유의미한 선택, 디자인 원칙, 배제 원칙, evidence-id, 성공 신호, 담당자를 연결한다.

## 근거 없는 재미의 경계 {#unsupported-fun-boundary}

재미를 나타내는 형용사는 근거가 아니라 가설이다. 가정을 드러내고 승인 전에 관찰 가능한 플레이어 행동 또는 테스트를 요구한다.

## 작성 기록 {#working-record}

| 항목 ID | 상태 | 근거 또는 다음 작업 | 담당자 |
| --- | --- | --- | --- |
| `pillar-id` | not-observed | 승인 전에 프로젝트별 값과 근거 위치를 기록한다. | artifact-owner |
| `player-promise` | not-observed | 승인 전에 프로젝트별 값과 근거 위치를 기록한다. | artifact-owner |
| `design-rule` | not-observed | 승인 전에 프로젝트별 값과 근거 위치를 기록한다. | artifact-owner |
| `anti-pillar` | not-observed | 승인 전에 프로젝트별 값과 근거 위치를 기록한다. | artifact-owner |
| `evidence-id` | not-observed | 승인 전에 프로젝트별 값과 근거 위치를 기록한다. | artifact-owner |
| `success-signal` | not-observed | 승인 전에 프로젝트별 값과 근거 위치를 기록한다. | artifact-owner |

...
Connect each pillar-id to a target-player promise, desired emotion, core fun, meaningful choice, design rule, anti-pillar, evidence-id, success signal, and owner.

## Unsupported Fun Boundary {#unsupported-fun-boundary}

Fun adjectives are hypotheses, not evidence. Keep assumptions visible and require an observable player behavior or test before approval.

## Working Record {#working-record}

| Field ID | Current state | Evidence or next action | Owner |
| --- | --- | --- | --- |
| `pillar-id` | not-observed | Record a project-specific value and evidence address before approval. | artifact-owner |
| `player-promise` | not-observed | Record a project-specific value and evidence address before approval. | artifact-owner |
| `design-rule` | not-observed | Record a project-specific value and evidence address before approval. | artifact-owner |
| `anti-pillar` | not-observed | Record a project-specific value and evidence address before approval. | artifact-owner |
| `evidence-id` | not-observed | Record a project-specific value and evidence address before approval. | artifact-owner |
| `success-signal` | not-observed | Record a project-specific value and evidence address before approval. | artifact-owner |

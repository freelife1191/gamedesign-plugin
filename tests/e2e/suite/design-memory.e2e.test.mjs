...
test("10. default 257-child and 100,001-entry tripwires fail close without source blockage", { concurrency: false, timeout: filesystemCensusTestTimeout() }, async (t) => {

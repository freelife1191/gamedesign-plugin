...
test("core skill gate links project the canonical source registry into the package", async (t) => {
  const stagingRoot = await mkdtemp(path.join(tmpdir(), "studio-core-gates-"));

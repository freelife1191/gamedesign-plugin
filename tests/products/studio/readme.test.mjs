...
test("README exposes every shipped skill, role asset, profile, and canonical template", async () => {
  ...
  assert.match(readme, /제품 스킬 17개/u, "README states the direct product-skill count");
  assert.match(readme, /설치 스킬(?:은|이) 26개/u, "README states the complete installed-skill count");

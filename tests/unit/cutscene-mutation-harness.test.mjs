...
test("eleven cutscene mutations emit one exact, bounded dedicated-FD record", { timeout: 60_000 }, async () => {
...
]) test(`dedicated-FD harness fails closed for ${tamper}`, { timeout: 15_000 }, async () => {
